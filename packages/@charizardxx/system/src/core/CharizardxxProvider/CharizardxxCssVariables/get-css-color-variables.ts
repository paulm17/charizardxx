...
import { CharizardxxColor, CharizardxxTheme } from '../theme.types';
...
export function getCSSColorVariables({
  ...
  if (colorScheme === 'light') {
    ...
    const dynamicVariables = {
      [`color-${name}-text`]: `var(--charizardxx-color-${name}-filled)`,
      [`color-${name}-filled`]: `var(--charizardxx-color-${name}-${primaryShade})`,
      [`color-${name}-filled-hover`]: `var(--charizardxx-color-${name}-${
      ...
      [`color-${name}-light-color`]: `var(--charizardxx-color-${name}-${primaryShade})`,
      [`color-${name}-outline`]: `var(--charizardxx-color-${name}-${primaryShade})`,
  ...
  const dynamicVariables = {
    [`color-${name}-text`]: `var(--charizardxx-color-${name}-4)`,
    [`color-${name}-filled`]: `var(--charizardxx-color-${name}-${primaryShade})`,
    [`color-${name}-filled-hover`]: `var(--charizardxx-color-${name}-${
      primaryShade === 9 ? 8 : primaryShade + 1
    })`,
    ...
    [`color-${name}-light-color`]: `var(--charizardxx-color-${name}-${Math.max(primaryShade - 5, 0)})`,
    [`color-${name}-outline`]: `var(--charizardxx-color-${name}-${Math.max(primaryShade - 4, 0)})`,
