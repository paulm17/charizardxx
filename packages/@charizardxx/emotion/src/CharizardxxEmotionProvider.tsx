...
export function useEmotionCache() {
  ...
  if (cache === null) {
    throw new Error(
      'Emotion cache is not available in context, make sure that you have CharizardxxEmotionProvider in the component tree'
    );
  }
...
export const CharizardxxEmotionProvider = withEmotionCache<EmotionCacheProviderProps>(
  ({ children, cache }, ctx) => (
