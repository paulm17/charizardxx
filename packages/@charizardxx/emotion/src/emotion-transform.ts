import { useCharizardxxTheme } from '@charizardxx/core';
import { CharizardxxStylesTransform } from '@charizardxx/system';
...
export const emotionTransform: CharizardxxStylesTransform = {
  sx: sxTransform,
