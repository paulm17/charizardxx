...
type __ClassNames = undefined | Partial<Record<string, string>> | ((theme: CharizardxxTheme, props: Record<string, any>, ctx: Record<string, any> | undefined) => Partial<Record<string, string>>);
...
export declare function getClassName({ theme, options, themeName, selector, classNamesPrefix, classNames, classes, unstyled, className, rootSelector, props, stylesCtx, transformedStyles, }: GetClassNameOptions): string;
export {};
