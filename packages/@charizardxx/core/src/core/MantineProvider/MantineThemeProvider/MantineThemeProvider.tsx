...
export function useMantineTheme() {
  ...
  if (!ctx) {
    throw new Error(
      '@charizardxx/core: MantineProvider was not found in component tree, make sure you have it in your app'
    );
  }
...
MantineThemeProvider.displayName = '@charizardxx/core/MantineThemeProvider';
