import type { CharizardxxBreakpoint, CharizardxxColor, CharizardxxFontSize, CharizardxxLineHeight, CharizardxxSpacing } from '../../CharizardxxProvider';
export type StyleProp<Value> = Value | Partial<Record<CharizardxxBreakpoint | (string & {}), Value>>;
