...
export type DefaultCharizardxxColor = 'dark' | 'gray' | 'red' | 'pink' | 'grape' | 'violet' | 'indigo' | 'blue' | 'cyan' | 'green' | 'lime' | 'yellow' | 'orange' | 'teal' | (string & {});
...
} ? Record<CustomColors, CharizardxxColorsTuple> : Record<DefaultCharizardxxColor, CharizardxxColorsTuple>;
